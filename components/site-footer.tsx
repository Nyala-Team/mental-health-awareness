    ...
    <footer className="border-t border-border/70 bg-primary text-primary-foreground">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div className="max-w-sm">
            ...
            <p className="mt-4 text-pretty leading-relaxed text-primary-foreground/85">
              An independent youth mental-health education platform for Malaysia. Tak apa untuk
          ...
          <div className="grid grid-cols-2 gap-8 text-sm sm:grid-cols-3">
            <div>
              ...
              <ul className="mt-3 space-y-2 text-primary-foreground/85">
                <li>
                  <a href="#feelings" className="hover:text-primary-foreground">
                    Feelings
                  </a>
                </li>
                <li>
                  <a href="#myths" className="hover:text-primary-foreground">
                    Myths & Facts
                  </a>
                </li>
                <li>
                  <a href="#tools" className="hover:text-primary-foreground">
                    Coping Tools
                  </a>
                </li>
                <li>
            ...
            <div>
              <p className="font-display font-bold">Simulate</p>
              <ul className="mt-3 space-y-2 text-primary-foreground/85">
                <li>
                  <Link href="/practice" className="hover:text-primary-foreground">
                    Peer Support Practice
                  </Link>
                </li>
                <li>
                  <Link href="/quiz" className="hover:text-primary-foreground">
                    Knowledge Quiz
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2 text-primary-foreground/85">
                <li>
                  <a href="tel:999" className="hover:text-primary-foreground">
                    Emergency 999
                  </a>
                </li>
                <li>
                  <a href="tel:15999" className="hover:text-primary-foreground">
                    Talian Kasih 15999
                  </a>
                </li>
                <li>
                  <a href="tel:0376272929" className="hover:text-primary-foreground">
                    Befrienders KL
                  </a>
                </li>
                <li>
                  <a href="tel:15555" className="hover:text-primary-foreground">
                    Talian HEAL 15555
                  </a>
                </li>
              </ul>
        ...
        <div className="mt-10 border-t border-primary-foreground/20 pt-6 text-xs text-primary-foreground/70">
          ...
          <p className="mt-2">
            &copy; {new Date().getFullYear()} Okay Tak Okay. Made with care in Malaysia.
          </p>
        </div>
      </div>
    </footer>
